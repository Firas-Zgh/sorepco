...
[data-testid="stFileUploaderDropzone"] {
    border: 3px dashed rgba(139, 92, 246, 0.3) !important;
...
[data-testid="stFileUploaderDropzone"]::after {
    content: 'Glissez-déposez vos fichiers PDF ici\\Aou cliquez pour les sélectionner';
    font-size: 1.15rem;
    font-weight: 500;
    color: #e5e7eb;
